...
form.addEventListener('submit',(e) => {
  ...
  if (checkval.find(element => element == 'rm') && checkval.find(element => element == 'tq'))
  {
   ...
   if (!(checkval.find(element => element == 'pa')) || !(checkval.find(element => element == 'rm')) || !(checkval.find(element => element == 'cc')) || checkval.find(element => element == 'cn') || checkval.find(element => element == 'tq')) 
  {
    ...
    if (!(checkval.find(element => element == 'sg')) || !(checkval.find(element => element == 'ic')))  
  {
  ...
  {
    if (checkval.toString() == "cc,ic,pa,rm,sg") 
    {
